                ...
                try {
                    ...
                    if ($result->rowCount() > 0) {
                        ...
                        foreach ($result as $row) {
                            ...
                            echo "<tr><td>{$user_row['id']}</td><td>{$user_row['username']}</td><td>{$user_row['lastname']}, {$user_row['firstname']}</td><td><a class='confirm-delete' href='admin_delete.php?id={$row['id']}&tbl=user_group_link&group={$group_id}'>Delete</a></td></tr>";
                        }
                        echo "</table>";
                    } else {
