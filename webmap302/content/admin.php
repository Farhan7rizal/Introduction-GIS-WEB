            ...
            try {
                ...
                if ($result->rowCount() > 0) {
                    ...
                    foreach ($result as $row) {
                        ...
                        echo "<tr><td>{$row['id']}</td><td>{$row['name']}</td><td>{$row['descr']}</td><td>{$user_count}</td><td>{$page_count}</td><td><a href='admin_manage_users.php?id={$row['id']}'>Manage Users</a></td><td><a class='confirm-delete' href='admin_delete.php?id={$row['id']}&tbl=groups'>Delete</a></td><td><a href='admin_edit_group.php?id={$row['id']}'>Edit</a></tr>";
                    }
                    echo "</table>";
                } else {
            ...
            try {
                ...
                if ($result->rowCount() > 0) {
                    ...
                    foreach ($result as $row) {
                        ...
                        echo "<tr><td>{$row['id']}</td><td>{$row['name']}</td><td>{$row['url']}</td><td>{$group_row['name']}</td><td>{$row['descr']}</td><td><a class='confirm-delete' href='admin_delete.php?id={$row['id']}&tbl=pages'>Delete</a></td><td><a href='admin_edit_page.php?id={$row['id']}'>Edit</a></tr>";
                    }
                    echo "</table>";
                } else {
