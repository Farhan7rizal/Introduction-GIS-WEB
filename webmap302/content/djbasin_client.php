    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            lyrBUOWL.on('data:loaded', function() {
                ...
                jsnBUOWLbuffer = turf.buffer(lyrBUOWL.toGeoJSON(), 0.3, {
                    units: 'kilometers'
                });
                console.log(jsnBUOWLbuffer);
                lyrBUOWLbuffer = L.geoJSON(jsnBUOWLbuffer, {
                    style: {
                        color: 'yellow',
                        dashArray: '5,5',
                        fillOpacity: 0
        ...
        function styleBUOWL(json) {
            ...
            switch (att.hist_occup) {
                case 'Yes':
                    return {
                        color: 'deeppink', fillColor: 'yellow'
                    };
                    break;
                case 'Undetermined':
                    return {
        ...
        function processClientLinears(json, lyr) {
            ...
            var jsnBuffer = turf.buffer(json, att.row_width / 1000, {
                units: 'kilometers'
            });
            var lyrBuffer = L.geoJSON(jsnBuffer, {
                style: {
                    color: 'gray',
                    dashArray: '5,5'
                }
